    ...
    public function custom_menu_item_fields($item_id, $item, $depth, $args) {
        ...
        <p class="description description-wide">
            <label for="edit-menu-item-badge-<?php echo $item_id; ?>">
                <?php _e('Menu Badge Text', 'my-profile-menu'); ?><br>
                <input type="text" id="edit-menu-item-badge-<?php echo $item_id; ?>" name="menu-item-badge[<?php echo $item_id; ?>]" value="<?php echo esc_attr($badge_text); ?>" />
                <span class="description"><?php _e('Optional badge text displayed on the right.', 'my-profile-menu'); ?></span>
            </label>
        </p>
        <?php
        ...
        <p class="description description-wide">
            <label for="edit-menu-item-icon-<?php echo $item_id; ?>">
                <?php _e('Icon Class', 'my-profile-menu'); ?><br>
                <input type="text" id="edit-menu-item-icon-<?php echo $item_id; ?>" name="menu-item-icon[<?php echo $item_id; ?>]" value="<?php echo esc_attr($icon_class); ?>" />
                <span class="description"><?php _e('Example: fa fa-home', 'my-profile-menu'); ?></span>
            </label>
        </p>
        <?php
        ...
        <p class="description description-wide">
            <label for="edit-menu-item-role-<?php echo $item_id; ?>">
                <?php _e('User Role', 'my-profile-menu'); ?>
            </label>
            <select class="mpm-select2" id="edit-menu-item-role-<?php echo $item_id; ?>" name="menu-item-role[<?php echo $item_id; ?>]">
                <option value=""><?php _e('Select a role', 'my-profile-menu'); ?></option>
                <?php foreach ($roles as $role_key => $role): ?>
                    <option value="<?php echo $role_key; ?>" <?php selected($selected_role, $role_key); ?>>
    ...
    public function filter_nav_menu_items($menu_items, $args) {
        ...
        foreach ($menu_items as $key => $menu_item) {
            ...
            if ($meta['affiliate_only'] === 'yes' && !$this->is_affiliatewp_active()) {
             ...
             if ($menu_role && !in_array($menu_role, $user_roles)) {
